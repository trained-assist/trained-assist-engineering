...
// server, registry and transport are exercised for real; only LLM/Hermes and
// external network are faked (and this server does neither).
...
async function startMcp({ entrypoint = MCP_ENTRY, args = [], userId = 'test-mcp-user', workDir = process.cwd(), env = {}, callTimeoutMs = 20000 } = {}) {
  ...
  await call('initialize', {
    ...
    capabilities: {},
    clientInfo: { name: 'engineering-contract-test', version: '1.0' },
  });
